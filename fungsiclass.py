...
class gambar:
	...
	# Menginisialisasi pixel kedalam array list
	def __init__(self):
	...
	# Mereset gambar ke bentuk semula
	...
	# Mendapatkan nilai total pixel RGB pada gambar
	def totalRGB(self):
	...
	# Mengubah intensitas dengan metode penambahan
	...
	# Mengubah intensitas dengan metode pengurangan
	...
	# Mengubah intensitas dengan metode perkalian
	...
	# Mengubah intensitas dengan metode pembagian
	...
	# Mendapatkan frekuensi masing-masing nilai pixel (0-255)
	...
	# Menyempurnakan Bentuk histogram supaya seimbang
	def histeq(self):
